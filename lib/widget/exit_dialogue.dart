        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                ElevatedButton(
                    style:  ButtonStyle(backgroundColor:   MaterialStateProperty.all(kCommonColor),),
                    onPressed: onPressed, child: Text('Yes',style: TextStyle(color: Colors.blueGrey.shade900),)),
                VerticalDivider(),
                ElevatedButton(
                    style:  ButtonStyle(backgroundColor:   MaterialStateProperty.all(kCommonColor),),
                    onPressed: ()=> Navigator.pop(context), child: Text('No',style: TextStyle(color: Colors.blueGrey.shade900))),
              ],
            ),
          ],
        ),
